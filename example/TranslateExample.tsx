...
export default function index() {
  ...
  return (
    <ScrollView style={{ width: '100%', height: '100%'}}>
      ...
      <ClipPathView  translateZ={2} viewBox={viewBox} d={myPath10} fill="#f00" style={{ width: 200, height: 150,  }}>
        <Text>MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM</Text>
      </ClipPathView>
      <ClipPathView translateZ={1} viewBox={viewBox} d={myPath10} fill="#0f0" style={{ width: 200, height: 150,  position: 'absolute', top: 30, left: 20 }}>
        <Text>MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM</Text>
      </ClipPathView>
      </View> 
